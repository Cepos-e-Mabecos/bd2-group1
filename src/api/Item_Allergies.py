...
# Define Blueprint
item_allergy = Blueprint('item_allergy', __name__)
...
# Get item_allergys
@item_allergy.route('/', methods=['GET'])
def get_items_allergies():
...
# Get item_allergys
@item_allergy.route('/<cod_zone>', methods=['GET'])
def get_item_allergy(cod_zone):
    try:
        # Establish the connection and creation of the cursor
        connection = create_connection()
        cur = connection.cursor()
...
# Post item_allergy
@item_allergy.route('/', methods=['POST'])
def post_item_allergy():
    try:
        # Establish the connection and creation of the cursor
        connection = create_connection()
        cur = connection.cursor()
...
# Put item_allergy
@item_allergy.route('/<cod_zone>', methods=['PUT'])
def put_item_allergy(cod_zone):
    try:
        # Establish the connection and creation of the cursor
        connection = create_connection()
        cur = connection.cursor()
...
# Delete item_allergy
@item_allergy.route('/<cod_zone>', methods=['DELETE'])
def delete_item_allergy(cod_zone):
    try:
        # Establish the connection and creation of the cursor
        connection = create_connection()
        cur = connection.cursor()
